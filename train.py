...
def xgboost_cv():
    data = Datebase()
    train_start_date = '2018-03-05'
    train_end_date = '2018-04-06'
    test_start_date = '2018-04-11'
    test_end_date = '2018-04-16'

    sub_start_date = '2018-02-05'
    sub_end_date = '2018-03-05'
    sub_test_start_date = '2018-03-05'
    sub_test_end_date = '2018-03-10'
    ...
    sub_user_index, sub_trainning_date, sub_label = data.make_train_set(sub_start_date, sub_end_date,
